    ...
    return (
        <>
            <section className="mt-4 bg-bghome bg-cover h-screen w-auto flex flex-col justify-center text-center items-center text-white">
                ...
                <h1 className="font-semibold text-9xl mb-10 drop-shadow-lg"> YAYOI  KUSAMA </h1>
                ...
                <button className="bg-white text-black m-20 mt p-5 text-lg drop-shadow-lg">Entrez dans la chambre</button>
